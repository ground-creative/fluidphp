		...
		*/
		protected function _parseXML( )
		{
			...
			( 
				...
				\App::option( 'website.current_route_param' )  	=>	Website::currentRoute( ) ,
				\App::option( 'website.current_page_param' )  	=>	$this->_page ,
				\App::option( 'website.meta_tags_param' )		=>	Website::getMetaTags( ) ,
				\App::option( 'website.current_path_param' )  	=>	\Website::getPath( )
			);
