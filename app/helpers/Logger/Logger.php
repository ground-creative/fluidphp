<?php
	...
	class Logger
	{
		...
		{
			return LoggerInstance::observe( $class );
		}
		
		public static function lastError( )
		{
			$error = error_get_last( );
			if ( 'Php Error' === \system\PhpToolCase\PtcDebug::msgType( $error[ 'type' ] ) )
			{
		...
		public static function errorHandler( $errno , $errstr , $errfile , $errline )
		{
			...
			$err = \system\PhpToolCase\PtcDebug::msgType( $errno );
		...
		{
			$buffer = \system\PhpToolCase\PtcDebug::getBuffer( );
