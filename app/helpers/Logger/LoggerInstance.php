<?php
	...
	class LoggerInstance extends \Model
	{
		...
		{
			static::$_sessionID = ( '' !== session_id( ) ) ? session_id( ) : 
							\system\PhpToolCase\PtcAuth::random( 26 );		
		}
		...
		protected function _addClientData( )
		{
			...
			$this->domain = \system\PhpToolCase\PtcRouter::getProtocol( ) . '://' . $_SERVER[ 'HTTP_HOST' ];
		}
	}